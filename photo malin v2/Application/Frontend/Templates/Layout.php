	...
	<div class="row">
		<div class="col-md-12 hidden-md hidden-lg ">
			<div class="jumbotron">
				...
				<p><a class="btn btn-primary btn-lg" role="button">En savoir plus</a></p>
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-md-4">
			<div class="jumbotron">
				<h1>News</h1>
				<p>Pas de chance pas de news pour l'instant, le site est toujours en construction</p>
				<p>Le site est en pleine evolution du design si il y a des erreurs ne vous inquiétez pas je travaille dessus vous pouvez toujours me prevenir via le lien" me contacter"</p>
				<p><a class="btn btn-primary btn-lg" role="button">Plus de news</a></p>
			</div>
		</div>	
	</div>
 </div>
